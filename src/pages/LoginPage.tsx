    ...
    <div className="min-h-screen flex items-center justify-center bg-background p-4">
      <div className="w-full max-w-md animate-fade-in">
        <div className="text-center mb-8">
          <img src={logo} alt="Elimu Vault Logo" className="h-24 w-auto mx-auto mb-4" />
          <h1 className="font-heading text-3xl font-bold">Elimu Vault</h1>
          <p className="text-muted-foreground mt-1 text-sm">Secure Financial Aid Unlocking Future</p>
        </div>
